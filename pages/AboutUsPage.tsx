...
const AboutUsPage: React.FC = () => {
  return (
    <div className="bg-vt-surface p-8 rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-vt-text-light mb-6 border-b border-vt-bg pb-2">About VTLabs</h1>
      <div className="space-y-6 text-vt-text-secondary">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-vt-purple">Our Mission</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-vt-purple">Our Vision</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-vt-purple">Our Team</h2>
