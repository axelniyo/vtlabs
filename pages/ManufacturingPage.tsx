...
const ManufacturingPage: React.FC = () => {
  return (
    <div className="bg-vt-surface p-8 rounded-lg shadow-md">
      <h1 className="text-3xl font-bold text-vt-text-light mb-6 border-b border-vt-bg pb-2">Manufacturing</h1>
      <div className="space-y-4 text-vt-text-secondary">
        ...
        <h2 className="text-2xl font-semibold text-vt-purple pt-4">Our Capabilities</h2>
